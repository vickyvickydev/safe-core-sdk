...
const config = {
  ...
  paths: {
    artifacts: path_1.default.resolve(__dirname, './artifacts'),
    deploy: path_1.default.resolve(__dirname, './src/hardhat/deploy'),
    sources: path_1.default.resolve(__dirname, './contracts')
  },
  networks: {
    localhost: {
