...
var _FallbackHandlerManager_safeProvider,
...
class FallbackHandlerManager {
  ...
  validateFallbackHandlerAddress(fallbackHandlerAddress) {
    const isValidAddress = __classPrivateFieldGet(
      this,
      _FallbackHandlerManager_safeProvider,
      'f'
  ...
  async isFallbackHandlerCompatible() {
    ...
    const safeVersion = __classPrivateFieldGet(
      this,
      _FallbackHandlerManager_safeContract,
      'f'
    ).safeVersion
  ...
  async getFallbackHandler() {
    ...
    return __classPrivateFieldGet(this, _FallbackHandlerManager_safeProvider, 'f').getStorageAt(
...
;(_FallbackHandlerManager_safeProvider = new WeakMap()),
