...
var _ContractManager_instances,
  ...
  _ContractManager_initializeContractManager
...
class ContractManager {
  ...
  static async init(config, safeProvider) {
    ...
    await __classPrivateFieldGet(
      contractManager,
      _ContractManager_instances,
      'm',
      _ContractManager_initializeContractManager
    ).call(contractManager, config, safeProvider)
...
;(_ContractManager_contractNetworks = new WeakMap()),
  ...
  (_ContractManager_instances = new WeakSet()),
  (_ContractManager_initializeContractManager =
    async function _ContractManager_initializeContractManager(config, safeProvider) {
