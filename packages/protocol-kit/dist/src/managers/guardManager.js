...
class GuardManager {
  ...
  validateGuardAddress(guardAddress) {
    const isValidAddress = __classPrivateFieldGet(this, _GuardManager_safeProvider, 'f').isAddress(
      guardAddress
    )
  ...
  async getGuard() {
    ...
    return __classPrivateFieldGet(this, _GuardManager_safeProvider, 'f').getStorageAt(
...
;(_GuardManager_safeProvider = new WeakMap()),
