...
class BaseContract {
  ...
  constructor(
    ...
    const resolvedAddress =
      customContractAddress ??
      __classPrivateFieldGet(this, _BaseContract_instances, 'm', _BaseContract_resolveAddress).call(
        this,
...
;(_BaseContract_instances = new WeakSet()),
  (_BaseContract_resolveAddress = function _BaseContract_resolveAddress(
    networkAddresses,
    deployment,
    deploymentType
  ) {
