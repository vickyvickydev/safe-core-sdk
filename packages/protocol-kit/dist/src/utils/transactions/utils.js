...
exports.createTxOptions =
  exports.createLegacyTxOptions =
  exports.isLegacyTransaction =
  exports.convertTransactionOptions =
  exports.toTransactionRequest =
  exports.toEstimateGasParameters =
...
function encodeMetaTransaction(tx) {
  ...
  const encoded = (0, viem_1.encodePacked)(
...
exports.toTransactionRequest = toTransactionRequest
